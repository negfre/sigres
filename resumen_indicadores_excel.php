    ...
    $sql = "SELECT 
	  ...
	  SUM(c001t_requerimiento.nu_tiempo_efectivo)/60 as TOTAL_HH
		...
		WHERE 
		  ...
		  (i007t_servicio.co_servicio > 2 AND public.i007t_servicio.co_servicio < 9) AND
	...
	while($row = pg_fetch_array($result))
			{
				...
				$proceso = 'MANEJO DEL DATO';#$row['proceso'];
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('MD');
...
$fileName = "Indicadores de Gestión v1";
