...
switch($operacion){
  case 'NUEVO':
      $sql = " INSERT INTO i007t_servicio(tx_nombre_servicio,tx_obs_servicio,in_activo)
                VALUES('".$_POST['nombreServicio']."','".$_POST['obsServicio']."',1)";
       if (!$rs=consultas($sql))
      {
     ...
     break;
  case 'ACTUALIZAR':
          $sql = "UPDATE i007t_servicio SET tx_nombre_servicio='".$_POST['nombreServicio']."',tx_obs_servicio='".$_POST['obsServicio']."',in_activo=1 WHERE co_servicio=".$_POST['codServicio'];
      if (!$rs=consultas($sql))
      {
        echo '{"success": false, "errors":{"reason": "Error al momento de grabar"}}';
       }
