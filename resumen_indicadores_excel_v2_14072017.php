...
//require_once 'bd.php';  
function conectarBD(){
  $cnn = pg_connect("host=localhost port=5432 dbname=sigres_mtn user=postgres password=12345") or die("No se pudo conectar con el servidor");
  return $cnn;
}
...
WHERE 
  2017 = extract(year from c001t_requerimiento.fe_fin_requerimiento)::int AND
  ...
  (i007t_servicio.co_servicio > 12 AND public.i007t_servicio.co_servicio < 16) AND
...
//   i022t_grupo_proyecto.co_grupo_proyecto = i003t_proyecto.co_grupo_proyecto AND
//   i008t_actividad.co_servicio = i007t_servicio.co_servicio AND 
//   (i007t_servicio.co_servicio = 1 OR public.i007t_servicio.co_servicio = 2) AND
//   	  i022t_grupo_proyecto.tx_nombre_grupo_proyecto NOT LIKE 'NO APLICA' AND
// 	  i015t_indicador_gestion.tx_nombre_indicador_gestion  NOT LIKE 'NO APLICA' AND
// 	  c001t_requerimiento.co_estatus = 2 
...
// 	  ANIO_MES  
// ORDER BY
//   i015t_indicador_gestion.tx_nombre_indicador_gestion ASC";
...
// 				$indicador = $row['indicador'];
// 				$proceso = 'MEMORIA CORPORATIVA';#$row['proceso'];
// 				$anio_mes = $row['anio_mes'];
...
//   i022t_grupo_proyecto.co_grupo_proyecto = i003t_proyecto.co_grupo_proyecto AND
//   i008t_actividad.co_servicio = i007t_servicio.co_servicio AND 
//   (i007t_servicio.co_servicio = 9 OR public.i007t_servicio.co_servicio = 11) AND
//   	  i022t_grupo_proyecto.tx_nombre_grupo_proyecto NOT LIKE 'NO APLICA' AND
// 	  i015t_indicador_gestion.tx_nombre_indicador_gestion  NOT LIKE 'NO APLICA' AND
// 	  c001t_requerimiento.co_estatus = 2 
...
// 				$proyecto = $row['proyecto'];
// 				$indicador = $row['indicador'];
// 				$proceso = 'SOPORTE A FLUJOS DE TRABAJO';#$row['proceso'];
// 				$anio_mes = $row['anio_mes'];
// 				$cadAct = $proceso . ' ' . $gerencia . ' ' . $proyecto . ' ' . $indicador;
// 				$totalservicios = $row['total_req'];
// 				$totalhh = $row['total_hh'];
...
// 	GROUP BY
// 	  Gerencia,Proyecto,ANIO_MES
// ORDER BY
//   i022t_grupo_proyecto.tx_nombre_grupo_proyecto,proyecto ASC";
