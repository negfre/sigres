...
function check_fecha() {
    ...
    //Cierre Enero
    $start_ts = strtotime("28-02-2024");
    $end_ts = strtotime("28-02-2024");
    if (($fecha >= $start_ts) && ($fecha <= $end_ts))
      ...
      if (($fecha >= $start_ts) && ($fecha <= $end_ts))
       return true; 
        ...
        //Cierre Marzo  
        $start_ts = strtotime("31-03-2024");
        $end_ts = strtotime("31-03-2024");
        if (($fecha >= $start_ts) && ($fecha <= $end_ts))
          return true; 
        else{
          //Cierre Abril
          $start_ts = strtotime("30-03-2024");
          $end_ts = strtotime("30-04-2024");
          if (($fecha >= $start_ts) && ($fecha <= $end_ts))
            return true; 
          else{
            //Cierre Mayo
            $start_ts = strtotime("31-05-2024");
            $end_ts = strtotime("31-05-2024");
            if (($fecha >= $start_ts) && ($fecha <= $end_ts))
              return true; 
            else{
              //Cierre junio
              $start_ts = strtotime("30-06-2024");
              $end_ts = strtotime("30-06-2024");
              if (($fecha >= $start_ts) && ($fecha <= $end_ts))
                return true; 
              else{
                //Cierre Julio
                $start_ts = strtotime("31-09-2024");
                $end_ts = strtotime("31-09-2024");
                if (($fecha >= $start_ts) && ($fecha <= $end_ts))
                 return true; 
                else{
                   //Cierre Agosto  
                   ...
                   if (($fecha >= $start_ts) && ($fecha <= $end_ts))
                     ...
                     //Cierre Septiembre
                     $start_ts = strtotime("30-09-2024");
                     $end_ts = strtotime("30-09-2024");
                     if (($fecha >= $start_ts) && ($fecha <= $end_ts))
                       return true;
                     else{
                       //Cierre Octubre
                       $start_ts = strtotime("31-10-2024");
                       $end_ts = strtotime("31-10-2024");
                       if (($fecha >= $start_ts) && ($fecha <= $end_ts))
                          return true;
                       else{
		  	               //Cierre Noviembre
	                  $start_ts = strtotime("31-11-2024");
	                  $end_ts = strtotime("31-11-2024");
	                  if (($fecha >= $start_ts) && ($fecha <= $end_ts))
	                    return true;
                          else{
                             //Cierre Diciembre 
	                     $start_ts = strtotime("31-12-2024");
	                     $end_ts = strtotime("31-12-2024");
	                     if (($fecha >= $start_ts) && ($fecha <= $end_ts))
	                        return true;
	                     else
	                        return false;
