...
$objPHPExcel->getProperties()->setCreator("SIG-CGR")
				            ->setLastModifiedBy("SIG-CGR")
...
ORDER BY
  ...
  i009t_subactividad.tx_nombre_subactividad ASC";
	...
	->SetCellValue('Q'.$fila, 'TIEMPO EFECTIVO')
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('Listado de Requerimientos');
...
// $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, Excel2007 '2007'); 
//Excel5
// $objWriter->save('php://output'); 

// Redirect output to a client’s web browser (Excel2007)
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Listado de Requerimientos.xlsx"');
header('Cache-Control: max-age=0');
