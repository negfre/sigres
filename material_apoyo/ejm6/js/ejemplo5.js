	...
	Ext.onReady(function(){ // Inicializamos 
			...
			w_ejemplo = new Ext.Window({ 	// Creamos nuestra ventana
				...
				items: [					//Aquí incluimos los componentes que estaran dentro de nuestra ventana (en este caso el formulario)
						...
						items: [			//Aquí incluimos los componentes que estaran dentro de nuestro formulario
							{
				...
				buttons:[			// Aqui incluiremos los botones del formulario
						{
							...
							handler:function(){	
								if (Ext.getCmp('formulario').getForm().isValid()) { // Validamos el formulario
											Ext.Msg.show({
													   title:'Confirmación',
													   msg: 'Los datos estan listos para ser grabados',
													   buttons: Ext.Msg.OK,
											...
											Ext.Msg.show({
													   title:'Error',
													   msg: 'Antes de continuar debe completar los datos',
													   buttons: Ext.Msg.OK,
